...
public class Noticebill implements java.io.Serializable {
	...
	private String id;
	private User user;  //业务通知单对应的受理人
	private Staff staff; //业务通知单匹配到的取派员
	private String customerId;//业务通知单所属的客户id
	...
	public String toString() {
		return "Noticebill [id=" + id + ", user=" + user + ", staff=" + staff + ", customerId=" + customerId
				...
				+ ", ordertype=" + ordertype + ", workbills=" + workbills + ", pickdateStr=" + pickdateStr + "]";
	}
