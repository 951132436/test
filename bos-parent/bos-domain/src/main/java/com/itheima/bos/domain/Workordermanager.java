...
public class Workordermanager implements java.io.Serializable {
	...
	/** minimal constructor */
	public Workordermanager(String id) {
		this.id = id;
	}

	/** full constructor */
	public Workordermanager(String id, String arrivecity, String product,
			...
			String receiveraddr, Integer feeitemnum, Double actweit,
	...
	public Double getActweit() {
		return actweit;
	}

	public void setActweit(Double actweit) {
		this.actweit = actweit;
	}
	...
	public String toString() {
		return "Workordermanager [id=" + id + ", arrivecity=" + arrivecity + ", product=" + product + ", num=" + num
				+ ", weight=" + weight + ", floadreqr=" + floadreqr + ", prodtimelimit=" + prodtimelimit + ", prodtype="
				+ prodtype + ", sendername=" + sendername + ", senderphone=" + senderphone + ", senderaddr="
				+ senderaddr + ", receivername=" + receivername + ", receiverphone=" + receiverphone + ", receiveraddr="
				+ receiveraddr + ", feeitemnum=" + feeitemnum + ", actweit=" + actweit + ", vol=" + vol
				+ ", managerCheck=" + managerCheck + ", updatetime=" + updatetime + "]";
	}
