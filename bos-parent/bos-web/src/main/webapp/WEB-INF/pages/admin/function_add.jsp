...
<div data-options="region:'center'">
	<form id="functionForm" action="functionAction_save.action" method="post">
...
<!-- 								data-options="valueField:'id',textField:'name',url:'functionAction_listajax.action'"/> -->
							<!-- 通过combotree展示权限数据 -->
							<input name="parentFunction.id" class="easyui-combotree" data-options="url:'functionAction_listajaxForCombotree.action'">
						</td>
					</tr>
					<tr>
						<td>描述</td>
