...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="noticebillAction_save.action" method="post">
						...
						<script type="text/javascript">
							$(function(){
								...
								$("input[name=telephone]").blur(function(){
									//获取到输入项值
									var tel = this.value;
									//调用业务通知单action，远程调用crm服务端的方法
									$.post('noticebillAction_findCustomerByTel.action',{'telephone':tel},function(data){
										if(data == null){
											//清空输入项
