...
<textarea name="adviceContent" id="bug_c" cols="50" rows="7" style=" border:solid 3px #E2E2E2;line-height:16px; padding:5px;"></textarea>
<br />
...
//功能相对独立，应该单独放置
$('#bug_form').form({  
	url:"userAdviceAction_saveAdvice.action",  
	onSubmit: function(){  
		if($('#bug_c').val()==""){
			$.messager.alert('温馨提示',"亲，您真的无话可说了吗？那就不要说了……");	
			return false;
		}
	}, 
	success:function(data){  
		$.messager.alert('温馨提示',"您的宝贵意见已成功提交！"); 
		$('#bug_c').val("");
	}  
});   
</script>